...
<div class="bg-white rounded-xl shadow p-4 lg:p-6">
    ...
    <div class="flex items-start justify-between gap-3 mb-4 flex-wrap">
        <div>
            ...
            <p class="text-xs sm:text-sm text-gray-400 mt-0.5">Riwayat laporan kesalahan data yang pernah Anda kirim</p>
        </div>
        <a href="{{ route('data_reports.create') }}"
           class="px-3 py-2 btn-primary text-xs font-semibold rounded-lg shadow-sm flex items-center gap-1.5 transition-colors">
            <i class="fas fa-flag"></i>
            <span>Laporkan Data Baru</span>
        </a>
    </div>

    <form method="GET" action="{{ route('data_reports.index') }}"
        ...
        <table class="w-full text-left">
            <thead>
                <tr class="border-b border-gray-100 text-xs text-gray-400 uppercase tracking-wide">
                    ...
                    <th class="px-4 py-2 font-semibold">Dilaporkan</th>
